...
\begin{entrylist}
  \entry
    ...
    {Java Developer}
    {Ikorn Solutions}
   {\textbf{1. Dubu Suite:} We have built multiple applications and communications systems that are widely-used in our target industries.\\
	...
	\begin{itemize}
		\item \textbf{Development Languages:} Java, C++, HTML/CSS/JS
		\item \textbf{Technologies:}
			...
			\end{itemize}
		\item \textbf{Engineer Engagement} 16 personnel
		\item \textbf{Project Duration} 36 months
		\item \textbf{Component products :} Dubu messenger, Dubu mail, dubu log, dubu sns, dubu disk, dubu editor
	\end{itemize}}
\entry
    {11/15 - Now}
    {Java Developer}
    {Ikorn Solutions}
	{\textbf{2. Dubu Plus: } A multifunctional responsive web builder that makes it easy to create a website without any professional knowledge.
	...
	\begin{itemize}
		\item \textbf{Development Languages:} PHP/ HTML/ CSS/ JS
		\item \textbf{Technologies:}
			\begin{itemize}
				...
				\item \textbf{Protocol:} MySQL, NoSQL (Mongo, Mnesia)
			\end{itemize}
		\item \textbf{Engineer Engagement:} 10 personnel
		\item \textbf{Project Duration} 24  months
	\end{itemize}}
\end{entrylist}
\begin{entrylist}
\entry
    ...
    {Java Developer}
    {Ikorn Solutions}
	{\textbf{3. Quark}  is B2B marketplace for marketing affiliate partners with \#Value Links.\\ 
	...
	\begin{itemize}
		...
		\item \textbf{Technologies:}
			...
			\end{itemize}
		\item \textbf{Engineer Engagement:} 11 personnel
		\item \textbf{Project Duration} 12  months
	\end{itemize}}
\end{entrylist}
\begin{entrylist}
%$-$
\entry
    ...
    {Java Developer}
    {Ikorn Solutions}
	{\textbf{4. Data Annotation: } We label all videos and images that were recorded while driving. This ground truth is the basis for training objects detection algorithms.\\
	...
	\begin{itemize}
		...
		\item \textbf{Technologies:}
			\begin{itemize}
				...
				\item \textbf{Protocol:} Http/https
			\end{itemize}
		\item \textbf{Engineer Engagement:} 12 personnel
		\item \textbf{Project Duration} 12/2017 - Present
	\end{itemize}
}
  \entry
    {09/15 - 11/15}
